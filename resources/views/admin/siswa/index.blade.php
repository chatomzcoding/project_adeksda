                                        ...
                                        <form id="data-{{ $item->id }}" action="{{url($main['link'].'/'.$item->id)}}" method="post">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    <button type="button" data-toggle="modal" data-nama="{{ $item->nama }}" data-nis="{{ $item->nis }}"  data-alamat="{{ $item->alamat }}"  data-tgl_lahir="{{ $item->tgl_lahir }}"  data-no_telp="{{ $item->no_telp }}"  data-jk="{{ $item->jk }}"  data-status="{{ $item->status }}"  data-id="{{ $item->id }}" data-target="#ubah" title="" class="dropdown-item" data-original-title="Edit Data"><i class="fa fa-edit text-success" style="width: 25px"> </i> EDIT
                                                    </button>
