            ...
            <div class="card">
              <div class="card-header">
                {{-- <h3 class="card-title">Daftar Unit</h3> --}}
                    <a href="{{ url('halaman/buatkontrak') }}" class="btn btn-outline-primary btn-sm pop-info" title="Tambah Data List Baru" ><i class="fas fa-plus"></i> Buat Kontrak</a>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        <thead class="text-center">
                            <tr>
                                <th width="5%">No</th>
                                <th width="10%">Aksi</th>
                                <th>Kode - Nama Paket Pekerjaan</th>
                                <th>Sub Kegiatan</th>
                                <th>Kode Tender</th>
                                <th>Alamat</th>
                                <th>Sumber Dana</th>
                                        ...
                                        <form id="data-{{ $item['id'] }}" action="{{url($main['link'].'/'.$item['id'])}}" method="post">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    <button class="dropdown-item"><i class="fas fa-file text-primary"style="width: 25px"></i> PERUSAHAAN</button>
                                                    <button class="dropdown-item"><i class="fas fa-file text-primary"style="width: 25px"></i> PEGAWAI</button>
                                                    <button class="dropdown-item"><i class="fas fa-file text-primary"style="width: 25px"></i> DOKUMEN</button>
                                                    <button class="dropdown-item"><i class="fas fa-file text-primary"style="width: 25px"></i> INFORMASI KONTRAK</button>
